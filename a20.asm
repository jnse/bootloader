; -----------------------------------------------------------------------------
; Functions dealing with the A20 memory address line on legacy systems.
; 
; Modern systems no longer have an A20 gate, but on some older machines we
; need to enable it to access memory over 1MB.
; -----------------------------------------------------------------------------

; Main function to enable A20
; 
; Tries various mechanisms to enable A20.
; Halts on failure.
;
enable_a20:
    pusha
